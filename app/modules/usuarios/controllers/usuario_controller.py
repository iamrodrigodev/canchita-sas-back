...
@usuario_router.get('/{usuario_id}/perfil', dependencies=[Depends(verificador_propietario_o_admin_dep)])
...
@usuarios_gestion_router.post('', dependencies=[Depends(requiere_rol("ADMINISTRADOR"))])
...
@usuarios_gestion_router.get('', dependencies=[Depends(requiere_rol("ADMINISTRADOR"))])
...
@usuarios_gestion_router.get('/{usuario_id}', dependencies=[Depends(requiere_rol("ADMINISTRADOR"))])
...
@usuarios_gestion_router.put('/{usuario_id}', dependencies=[Depends(requiere_rol("ADMINISTRADOR"))])
...
@usuarios_gestion_router.patch('/{usuario_id}/estado', dependencies=[Depends(requiere_rol("ADMINISTRADOR"))])
...
@usuarios_gestion_router.delete('/{usuario_id}', dependencies=[Depends(requiere_rol("ADMINISTRADOR"))])
